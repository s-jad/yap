...
export default function Dashboard() {
  ...
  dashboardGrid.innerHTML = `
    <div class="dashboard-card" tabindex="2">
      <p class="card-text">Connect with members</p>
    </div>    
    <div class="dashboard-card" tabindex="3">
      <p class="card-text">Form your own tribe</p>
    </div>    
    <div class="dashboard-card" tabindex="4">
      <p class="card-text">Join an existing tribe</p>
    </div>    
    <div class="dashboard-card" tabindex="5">
      <p class="card-text">Plan a gathering</p>
    </div>    
    <div class="dashboard-card" tabindex="6">
      <p class="card-text">Join a gathering</p>
    </div>    
    <div class="dashboard-card" tabindex="7">
